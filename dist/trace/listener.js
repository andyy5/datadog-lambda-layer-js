...
var TraceListener = /** @class */ (function () {
    ...
    TraceListener.prototype.onWrap = function (func) {
        var _a;
        var rootTraceContext = this.currentTraceHeaders;
        var spanContext = null;
        if (this.contextService.traceSource === constants_1.Source.Event || this.config.mergeDatadogXrayTraces) {
            spanContext = this.tracerWrapper.extract(rootTraceContext);
            utils_1.logDebug("Attempting to find parent for datadog trace trace");
        }
        else {
            utils_1.logDebug("Didn't attempt to find parent for datadog trace", {
        ...
        var options = {};
        if (this.context) {
            utils_1.logDebug("Applying lambda context to datadog traces");
        ...
        if (this.stepFunctionContext) {
            utils_1.logDebug("Applying step function context to datadog traces");
